...
// Test for contract, takes Truffle accounts variable as parameter
contract("Greeter", (accounts) => {
    it("has been deployed successfully", async () => {
        // Getting greeter contract after it has been deployed
        const greeter = await GreeterContract.deployed();
        
        // Asserting greeter contract, else it failed to deploy
...
contract("Greeter: update greeting", (accounts) => {
    describe("setGreeting(string)", async () => {
        describe("when message is sent by owner", () => {
